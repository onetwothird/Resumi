...
export default function PublicFooter() {
  ...
  return (
    <footer className="relative z-10 bg-slate-900 dark:bg-slate-950 border-t border-white/10">
      ...
      <div className="border-t-2 border-b-2 border-indigo-500/30 bg-slate-800 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
          <div className="max-w-2xl mx-auto">
            {/* Section header */}
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-indigo-500/15 mb-4">
            ...
            {tSubmitted ? (
              <div className="bg-slate-700/50 rounded-2xl p-8 sm:p-10 text-center border border-slate-600">
              ...
              <form
                ...
                className="bg-slate-700/50 rounded-2xl p-5 sm:p-8 border border-slate-600"
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
                  <input
                    ...
                    className="rounded-lg border border-slate-500 bg-slate-800 px-3.5 py-2.5 text-sm text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  />
                  <input
                    type="text"
                    value={tRole}
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full rounded-lg border border-slate-500 bg-slate-800 px-3.5 py-2.5 text-sm text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none mb-4"
                />
